page 70000 "DS Data Search"
{
    PageType = List;
    Caption = 'Search in company data';
    ApplicationArea = All;
    SourceTable = "DS Data Search Source Temp";  // necessary in order to position cursor in search field
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                Caption = 'Text to search for (min. 3 chars)';
                field(SearchString; SearchString)
                {
                    ...
                    trigger OnValidate()
                    var
                        DataSearchInTable: Codeunit "DS Data Search in Table";
            ...
            group(lines)
            {
                Caption = 'Results';
                ShowCaption = false;
                part(LinesPart; "DS Data Search lines")
                {
                    ApplicationArea = All;
                }
            }
    ...
    var
        ...
        SearchStringgrpCaption: Label 'Text to search for';
    ...
    var
        ...
        DataSearchDefaults: Codeunit "DS Data Search Defaults";
        DataSearchInTable: Codeunit "DS Data Search in Table";
        FeatureTelemetry: Codeunit "Feature Telemetry";
        SearchStrings: List of [Text];
    ...
    begin
        ...
        if not CurrPage.EnqueueBackgroundTask(NewTaskID, Codeunit::"DS Data Search in Table", Args) then
            exit(false);
