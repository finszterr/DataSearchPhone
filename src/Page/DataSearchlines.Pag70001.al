page 70001 "DS Data Search lines"
{
    PageType = ListPart;
    Caption = 'Results';
    ...
    InsertAllowed = false;
    DeleteAllowed = false;
    CardPageId = "DS Data Search line";
    ...
    actions
    {
        area(Processing)
        {
            action(Setup)
            {
                ...
                trigger OnAction()
                begin
                    Page.RunModal(Page::"DS Setup (Table) List");
                end;
            }
        }
    }
    ...
    var
        ...
        // %1 is a table name, e.g. Customer
        MoreRecLbl: Label '%1: Show all results';
        SearchString: Text;
