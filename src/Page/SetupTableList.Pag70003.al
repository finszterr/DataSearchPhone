page 70003 "DS Setup (Table) List"
{
    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            part(EnabledFields; "DS Setup (Field) Part")
            {
                ApplicationArea = All;
    ...
    var
        ...
        TempDataSearchSetupTable: Record "DS Data Search Setup (Table)" temporary;
    ...
    var
        "Field": Record "Field";
        DataSearchSetupFieldList: Page "DS Setup (Field) List";
    begin
        Field.FilterGroup(2);
    ...
    var
        DataSearchSetupTable2: Record "DS Data Search Setup (Table)";
    ...
    var
        DataSearchSetupTable2: Record "DS Data Search Setup (Table)";
        DataSearchSetupField: Record "DS Data Search Setup (Field)";
    begin
