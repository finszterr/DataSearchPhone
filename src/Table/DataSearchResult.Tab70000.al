table 70000 "DS Data Search Result"
{
    DataClassification = CustomerContent;
    Permissions = tabledata "DS Data Search Setup (Table)" = rm;
    ...
    fields
    {
        ...
        field(50000; SearchString; Text[250])
        {
        }
    }
        ...
        case Rec."Line Type" of
            Rec."Line Type"::Header:
                begin
                    ...
                    DataSearchEvents.OnAfterGetListPageNo(Rec, PageNo, RoleCenterID, SearchString);
                    if PageNo > 0 then
                        Page.Run(PageNo);
                end;
    ...
    procedure MapLinesRecToHeaderRec(var RecRef: RecordRef): Boolean
    var
        DataSearchEvents: Codeunit "DS Data Search Events";
        Mapped: Boolean;
        LineTableNo: Integer;
